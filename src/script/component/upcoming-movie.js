...
class UpcomingMovie extends HTMLElement {
  ...
  render() {
    this.innerHTML = `
        <style>
        .list-movie-scroll .card {
          width: 130px;
        }
        .list-movie-scroll .card-img-top {
          height: auto;
        }
        .list-movie-scroll .card-body p {
          font-size: 10px;
          padding: 3px 6px;
        }
        .list-movie-scroll .card-body img {
          width: 12px;
          height: auto;
        }
      </style>
      <div id="upcomingMovies" class="container-fluid my-4">
        <h2 class="my-2 text-white">Upcoming Movies</h2>
